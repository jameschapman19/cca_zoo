...
- Alternating Least Squares (:class:`SCCAPMD`, :class:`SCCAADMM`,
  :class:`SCCAIPLS`, :class:`SCCASpan`, :class:`WaijenborgCCA`,
...
# Deprecated aliases (SCCA_PMD, SCCA_ADMM, SCCA_IPLS, SCCA_Span -- underscored
# renames -- and ElasticCCA, renamed WaijenborgCCA) stay importable here for
# backward compatibility but are intentionally left out of __all__/docs,
# since they are being removed in a future release.
