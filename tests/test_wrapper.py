...
class TestWrapper(TestCase):
    ...
    def test_unregularized_methods(self):
        latent_dims = 1
        wrap_iter = cca_zoo.wrappers.CCA_ITER(latent_dims=latent_dims).fit(self.X, self.Y)
        ...
        self.assertIsNone(np.testing.assert_array_almost_equal(corr_iter, corr_scikit, decimal=2))
