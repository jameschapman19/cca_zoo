...
class DeCCAl_reg(nn.Module, ABC):
    def __init__(self, input_size_1: int, input_size_2: int, input_size_c: int, hidden_layer_sizes_1: list = None,
                 ...
                 learning_rate=1e-3):
        super(DeCCAl_reg, self).__init__()
        ...
        if model_c == 'fcn':
            self.decoder_c1 = LinReg(latent_dims,input_size_c)
            self.decoder_c2 = LinReg(latent_dims,input_size_c)
