...
def main():
    ...
    if debug:
        ...
        view_1, view_2, up, vp = CCA_methods.generate_data.generate_candola(1000, outdim_size, 101, 102, 0.01, 0.01)
    ...
    for run in range(runs):
        ...
        check_2=scikit.predict_view(test_set_1,None)
        check_1=scikit.predict_view(None,test_set_2)

        mse=((check_1-test_set_1)**2).mean()
        mserand=((np.random.normal(0,1,(500,101))-test_set_1)**2).mean()
